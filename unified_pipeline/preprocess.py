...
def get_anipose_calibration_files(p_calibration_target: Path, p_calib_timeline: Path, p_project_dir: Path) -> list:
    ...
    calibration_timeline = utils.load_config(p_calib_timeline) # specifies which calibration to use based on the timestamp on filename
